...
export class Transformer {
  ...
  private transformNode(node: NeoNode): unknown {
    return {
      ...mapValues(node.properties, this.transformValue.bind(this)),
    };
  }
  ...
  private transformRelation(rel: NeoRelation): unknown {
    return {
      ...mapValues(rel.properties, this.transformValue.bind(this)),
    };
  }
